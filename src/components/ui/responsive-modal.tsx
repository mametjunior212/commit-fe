...
type ModalContentProps = DialogPrimitive.DialogContentProps &
	VariantProps<typeof ModalVariants> & { total?: number };
...
const ModalContent = ({
	...
	const crowdedLgClasses =
		"lg:left-[30%] lg:top-[10%] lg:w-full lg:max-w-lg lg:translate-x-[-50%] lg:translate-y-[-50%]";
	const crowdedlowClasses =
		"lg:left-[30%] lg:top-[30%] lg:w-full lg:max-w-lg lg:translate-x-[-30%] lg:translate-y-[-30%]";
	...
	return (
		<ModalPortal>
			...
			<DialogPrimitive.Content
				...
				className={cn(ModalVariants({ side }), childrenCount < 10 ? crowdedlowClasses : crowdedLgClasses, className)}
			>
				{children}
