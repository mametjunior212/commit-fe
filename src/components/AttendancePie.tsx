...
const renderCustomizedLabel = (props: any) => {
    ...
    const radius = innerRadius + (outerRadius - innerRadius) * 0.6; // posisi teks
    const x = cx + radius * Math.cos(-midAngle * RADIAN);
    const y = cy + radius * Math.sin(-midAngle * RADIAN);

    const pct = props.total > 0 ? (value / props.total) * 100 : 0;
    // Sembunyikan label yang terlalu kecil (opsional)
                    ...
                    <div className="grid h-full min-h-0 grid-cols-2 gap-4"> {/* min-h-0 penting */}
                        ...
                        <div className="flex min-h-0 flex-col">
                            <div className="mb-1 text-xs font-medium text-muted-foreground">
                                Daftar Hadir Berdasarkan Pekerjaan
                            </div>
                        ...
                        <div className="flex min-h-0 flex-col">
                            <div className="mb-1 text-xs font-medium text-muted-foreground">
                                Daftar Hadir Berdasarkan Perusahaan
                            </div>
                            <div className="flex-1 min-h-0">
                                <ResponsiveContainer width="100%" height="100%">
                                    <PieChart
