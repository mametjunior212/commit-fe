...
import { staggerContainer, transition } from "@/components/features/calendar/animations";
      ...
      >
        {MONTHS.map((month, monthIndex) => {
          ...
          return (
            <motion.div
              key={month}
              className="flex flex-col border border-andrika rounded-lg shadow-sm overflow-hidden"
