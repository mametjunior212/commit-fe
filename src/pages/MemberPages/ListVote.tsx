...
import ListVotingSection from "@/components/sections/MemberPages/ListVotingSection";
    ...
    return (
        <HelmetProvider>
            <div className="p-6 max-w-7xl mx-auto">
                ...
                <h1 className="text-2xl font-semibold mb-2">List Voting</h1>

                <ListVotingSection params={params} onParamsChange={onParamsChange} />
            </div>
        </HelmetProvider>
    );
}